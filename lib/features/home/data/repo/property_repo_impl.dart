...
class PropertyRepoImpl implements PropertyRepo {
  ...
  @override
  Future<Either<Failure, GetPropertiesResponse>> getHomeProperties(
    ...
    try {
      ...
      final authResponse = await remoteDataSource.getHomeProperties(
          token: token, status: status, page: page);
  ...
  @override
  Future<Either<Failure, GetOnePropertyResponse>> getOneProperty(
    ...
    try {
      ...
      final authResponse = await remoteDataSource.getOneProperty(
